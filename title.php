...
<!-- Begin Content Container -->
  <div class="container">
    ...
    <?php
      $query  = 'SELECT tbl_inventory.*, tbl_titles.title, tbl_comics.series_id, tbl_comics.number, tbl_comics.number_order, tbl_comics.description, tbl_comics.creators, tbl_comics.variation_text, tbl_series.series, tbl_publishers.publisher, tbl_grades.grade_text, tbl_grades.grade_number FROM tbl_inventory ';
      ...
      $query .= 'ORDER BY tbl_comics.series_id, tbl_comics.number_order ASC ';      
